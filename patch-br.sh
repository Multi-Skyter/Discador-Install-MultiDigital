...
amportal restart
echo ""
echo "INSTALANDO TEMPLATE MULTI360 DIGITAL"
echo ""
cd /var/www/html/themes/
wget https://multi360digital.com.br/templates/multi360.tar.gz
tar -xzvf multi360.tar.gz
echo ""
echo "INSTALADO TEMPLATE MULTI360 DIGITAL - FAVOR TROCAR NO ADMIN"
echo ""
clear
echo " _____               _          _    _    ____  _____  "
echo "|_   _|             | |v$versao "' | |/\| |/\|  _ \|  __ \ '
